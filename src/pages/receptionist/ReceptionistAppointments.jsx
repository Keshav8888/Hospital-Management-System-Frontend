...
function ReceptionistAppointments() {
    ...
    const loadAppointments = async () => {
        ...
        try {
            ...
            const data =
                await getReceptionistAppointments(
                    keyword,
                    page,
                    size,
                    sortBy,
    ...
    const handleCancel = async (id) => {
        ...
        try {
            ...
            await cancelReceptionistAppointment(id);
    ...
    const getStatusClass = (status) => {
        ...
        return `receptionist-appointment-status receptionist-appointment-status-${String(
            status
        ).toLowerCase()}`;
    };
    ...
    if (loading) {
        ...
        return (
            <div className="receptionist-appointments-message">
    ...
    return (
        ...
        <div className="receptionist-appointments-page">
            ...
            <main className="receptionist-appointments-main">
                ...
                <div className="receptionist-appointments-content">
                    ...
                    <div className="receptionist-appointments-toolbar">
                        ...
                        <form
                            className="receptionist-appointment-search-form"
                            onSubmit={handleSearch}
                        >

                            <input
                                type="text"
                                className="receptionist-appointment-search-input"
                            ...
                            <button
                                type="submit"
                                className="receptionist-appointment-search-button"
                            >
                                Search
                            </button>
                    ...
                    <div className="receptionist-appointments-table-container">
                            ...
                            <tbody>
                                ...
                                {appointments.length === 0 ? (
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            colSpan="9"
                                            className="receptionist-appointments-empty"
                                        >
                                                ...
                                                <td>
                                                    ...
                                                    <div className="receptionist-appointment-actions">
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() =>
                                                                navigate(
                                                                    `/receptionist/appointments/${appointment.id}/reschedule`
                                                                )
                                                            }
                                                        >
                                                            Reschedule
                        ...
                        <div className="receptionist-appointments-pagination">
