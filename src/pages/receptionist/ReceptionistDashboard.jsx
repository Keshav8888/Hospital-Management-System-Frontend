    ...
    useEffect(() => {
        ...
        const loadDashboard = async () => {
            ...
            try {
                ...
                setTotalPatients(
                    patientsResponse.data.totalElements || 0
                );


                setTotalAppointments(
                    appointmentsResponse.data.totalElements || 0
                );
                ...
                <div className="receptionist-dashboard-content">
                    ...
                    <div className="receptionist-dashboard-header">
                        ...
                        <div>
                            ...
                            <p>
                                Overview of reception activities
                            </p>
                    ...
                    {error && (
                        <div className="receptionist-dashboard-error">
                            {error}
                        </div>
                    )}
                    ...
                    <div className="receptionist-dashboard-section">
                        ...
                        <div className="receptionist-quick-actions">
                            ...
                            >
                                ...
                                <span className="receptionist-action-icon">
                                    +
                                </span>
