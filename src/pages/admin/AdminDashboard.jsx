...
import { getDashboardGreeting, getLoggedInFirstName, } from "../../utils/dashboardGreeting";
    ...
    <div className="admin-layout">
      ...
      <main className="admin-main">
        ...
        <div className="admin-content">
          ...
          <p className="dashboard-subtitle">Overview of hospital activities</p>

          <div className="stats-grid">
            <StatCard title="Total Doctors" value={dashboard.totalDoctors} />

            <StatCard title="Total Patients" value={dashboard.totalPatients} />
